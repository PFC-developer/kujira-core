...
check-go-version:
	@if ! go version | grep -Eq "go1.19.[3-12]"; then \
		echo "\033[0;31mERROR:\033[0m Go version 1.19.3 through 1.19.12 is required for compiling kujirad. Installed version:" "$(shell go version)"; \
		exit 1; \
	fi
